...
$desired_columns = [1, 2, 3, 4, 5, 6];		// columns desired from the result of `df`

$disk_data = array();		// will be an array of associative arrays
...
foreach ($desired_columns as $column) {
	...
	// this is the re-mapping of columns to our desired format
